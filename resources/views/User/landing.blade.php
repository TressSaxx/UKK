...
<section class="header">
        ...
        <div class="container">
            <div class="container-fluid">
                ...
                <a class="navbar-brand" href="#">
                    ...
                    <p class="italic mt-0 text-white">Pelaporan Sekolah</p>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('lapor.formRegister') }}" class="btn btn-outline-purple">Register</a>
                        </li>
                    </ul>
                    @endauth
                </div>
    ...
    <div class="text-center">
        <h2 class="medium text-white mt-3">Layanan Pengaduan Sekolah</h2>
        <p class="italic text-white mb-5">Sampaikan laporan Anda langsung kepada pengurus Sekolah</p>
    </div>
    {{-- Wave --}}
...
<div class="row-content justify-content-center d-flex align-items-center mb-5">
    <div class="col-lg-6 col-10 col">
        <div class="content shadow">
            ...
            <div class="card mb-3">Input Laporan Disini</div>
            <form action="{{ route('lapor.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn btn-custom mt-2">Sampaikan</button>
            </form>
        </div>
    </div>
</div>
<div class="pengaduan mt-5">
    <div class="bg-purple">
        <div class="text-center">
            <h5 class="medium text-white mt-3">Live Update Jumlah Laporan</h5>
